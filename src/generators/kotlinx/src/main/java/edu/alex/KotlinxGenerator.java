...
public class KotlinxGenerator extends AbstractKotlinCodegen {

  public static final String DATE_LIBRARY = "dateLibrary";
  public static final String COLLECTION_TYPE = "collectionType";
  private static final Logger LOGGER = LoggerFactory.getLogger(KotlinxGenerator.class);
  ...
  /**
   * Constructs an instance of `KotlinxGenerator`.
   */
  public KotlinxGenerator() {
    super();

    artifactId = "kotlinx";
    packageName = "edu.alex";

    outputFolder = "generated-code" + File.separator + "kotlinx";
    modelTemplateFiles.put("model.mustache", ".kt");
    apiTemplateFiles.put("api.mustache", ".kt");
    modelDocTemplateFiles.put("model_doc.mustache", ".md");
    apiDocTemplateFiles.put("api_doc.mustache", ".md");
    embeddedTemplateDir = templateDir = "kotlinx";
